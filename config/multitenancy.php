...
return [
     ...
     *
     */
    // 'tenant_finder' => \App\Packages\Multitenancy\DomainTenantFinder::class,
    'tenant_finder' => App\TenantFinders\StaticTenantFinder::class,
     ...
     */
    // https://spatie.be/docs/laravel-multitenancy/v4/installation/using-multiple-databases#content-automatically-switching-to-the-database-of-the-current-tenant
    'switch_tenant_tasks' => [
    ...
    /*
     * Defines tenancy mode: "single_db" (shared DB) or "multi_db" (per-tenant DB).
     */
    'mode' => env('MULTITENANCY_MODE', 'single_db'),
];
