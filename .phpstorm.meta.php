...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\Contracts\OneTimePasswordRepositoryInterface' => \App\Repositories\Eloquent\OneTimePasswordRepository::class,
    ...
    override(\config(), map([
            ...
            'auth.password_reset.bypass_token_check' => 'boolean',
...
'auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','auth.password_reset.bypass_token_check','cache.default',
...
'cache.stores.failover.stores','cache.prefix','cloudinary.notification_url','cloudinary.cloud_url','cloudinary.upload_preset',
'cloudinary.upload_route','cloudinary.upload_action','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/eniola-akinlonu/laravel-auth-api/public/storage','frontend.reset_password_url',
'frontend.email_verification_url','frontend.allowed_hosts','jwt.secret','jwt.keys.public','jwt.keys.private',
...
'mail.markdown.paths','multitenancy.tenant_finder','multitenancy.tenant_artisan_search_fields','multitenancy.switch_tenant_tasks','multitenancy.tenant_model',
...
'multitenancy.tenant_aware_jobs','multitenancy.not_tenant_aware_jobs','multitenancy.mode','otp.length','otp.expiry_minutes',
'otp.max_attempts','otp.generator','otp.bypass_verification','permission.models.permission','permission.models.role',
...
'permission.cache.store','permission.defaults.guard','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'scribe.openapi.enabled','scribe.openapi.version','scribe.openapi.overrides','scribe.openapi.generators','scribe.groups.default',
...
'session.partitioned','session_security.inactivity_timeout','session_security.token_lifetime','sso.providers.google','ide-helper.filename',
...
'emails.otp','welcome','cloudinary::components.image','cloudinary::components.video','cloudinary::components.widget',
...
'GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI','AUTH_GUARD','AUTH_PASSWORD_BROKER',
'PAGINATION_PER_PAGE','CLOUDINARY_API_KEY','CLOUDINARY_API_SECRET','CLOUDINARY_CLOUD_NAME','CLOUDINARY_URL',
'FRONTEND_RESET_PASSWORD_URL','FRONTEND_EMAIL_VERIFICATION_URL',);
