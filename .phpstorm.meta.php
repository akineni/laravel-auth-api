...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\Contracts\AuthChallengeRepositoryInterface' => \App\Repositories\Eloquent\AuthChallengeRepository::class,
            'App\Repositories\Contracts\PasswordResetTokenRepositoryInterface' => \App\Repositories\Eloquent\PasswordResetTokenRepository::class,
            'App\Repositories\Contracts\RoleRepositoryInterface' => \App\Repositories\Eloquent\RoleRepository::class,
            'App\Repositories\Contracts\UserRepositoryInterface' => \App\Repositories\Eloquent\UserRepository::class,
            'App\Repositories\Contracts\UserRoleRepositoryInterface' => \App\Repositories\Eloquent\UserRoleRepository::class,
            'App\Services\OTP\Contracts\OtpGeneratorInterface' => \App\Services\OTP\Generators\NumericOtpGenerator::class,
    ...
    override(\config(), map([
            ...
            'app.pagination_per_page' => 'string',
            ...
            'filesystems.links./home/eniola-akinlonu/laravel-auth-api/public/storage' => 'string',
            'frontend.reset_password_url' => 'string',
            'frontend.email_verification_url' => 'string',
            'frontend.allowed_hosts' => 'array',
            'jwt.secret' => 'string',
            ...
            'multitenancy.mode' => 'string',
            'otp.length' => 'string',
            'otp.expiry_minutes' => 'string',
            'otp.max_attempts' => 'string',
            'otp.generator' => 'string',
            'otp.bypass_verification' => 'boolean',
            ...
            'permission.defaults.guard' => 'string',
            ...
            'session_security.inactivity_timeout' => 'string',
            'session_security.token_lifetime' => 'string',
            'sso.providers.google' => 'string',
            'sso.providers.facebook' => 'string',
            'tokens.activation.secret' => 'string',
            'tokens.activation.ttl_hours' => 'string',
...
'app.aliases.View','app.aliases.Vite','app.pagination_per_page','auth.defaults.guard','auth.defaults.passwords',
...
'cache.prefix','cloudinary.notification_url','cloudinary.cloud_url','cloudinary.upload_preset','cloudinary.upload_route',
'cloudinary.upload_action','database.default','database.connections.sqlite.driver','database.connections.sqlite.url','database.connections.sqlite.database',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/eniola-akinlonu/laravel-auth-api/public/storage','frontend.reset_password_url','frontend.email_verification_url',
'frontend.allowed_hosts','jwt.secret','jwt.keys.public','jwt.keys.private','jwt.keys.passphrase',
...
'mail.markdown.theme','mail.markdown.paths','mail.markdown.extensions','multitenancy.tenant_finder','multitenancy.tenant_artisan_search_fields',
'multitenancy.switch_tenant_tasks','multitenancy.tenant_model','multitenancy.queues_are_tenant_aware_by_default','multitenancy.tenant_database_connection_name','multitenancy.landlord_database_connection_name',
'multitenancy.current_tenant_context_key','multitenancy.current_tenant_container_key','multitenancy.shared_routes_cache','multitenancy.actions.make_tenant_current_action','multitenancy.actions.forget_current_tenant_action',
'multitenancy.actions.make_queue_tenant_aware_action','multitenancy.actions.migrate_tenant','multitenancy.queueable_to_job.Illuminate\\Mail\\SendQueuedMailable','multitenancy.queueable_to_job.Illuminate\\Notifications\\SendQueuedNotifications','multitenancy.queueable_to_job.Illuminate\\Queue\\CallQueuedClosure',
'multitenancy.queueable_to_job.Illuminate\\Events\\CallQueuedListener','multitenancy.queueable_to_job.Illuminate\\Broadcasting\\BroadcastEvent','multitenancy.tenant_aware_jobs','multitenancy.not_tenant_aware_jobs','multitenancy.mode',
'otp.length','otp.expiry_minutes','otp.max_attempts','otp.generator','otp.bypass_verification',
...
'permission.cache.expiration_time','permission.cache.key','permission.cache.store','permission.defaults.guard','queue.default',
...
'session.partitioned','session_security.inactivity_timeout','session_security.token_lifetime','sso.providers.google','sso.providers.facebook',
'tokens.activation.secret','tokens.activation.ttl_hours','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'role_or_permission','check.token.activity',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','auth.register','auth.login','auth.verify-otp',
'auth.resend-otp','auth.forgot-password','auth.reset-password','auth.refresh-token','auth.logout',
'activate-account','auth.sso.url','auth.sso.callback','auth.sso.exchange','users.me.',
'users.me.update','users.me.change-password','users.store','users.index','users.show',
'users.update','users.activate','users.deactivate','users.destroy','users.roles.assign',
'users.roles.revoke','roles.permissions','roles.index','roles.show','roles.store',
'roles.update','roles.destroy','user.two-fa.authenticator.qr-code','storage.local',
'storage.local.upload',);
        registerArgumentsSet('views', 
'emails.otp','welcome','cloudinary::components.button','cloudinary::components.image','cloudinary::components.video',
'cloudinary::js','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
...
'VITE_APP_NAME','OTP_LENGTH','OTP_EXPIRY_MINUTES','OTP_MAX_ATTEMPTS','OTP_BYPASS_VERIFICATION',
'PASSWORD_RESET_TOKEN_EXPIRY_MINUTES','SESSION_INACTIVITY_TIMEOUT_MINUTES','SESSION_TOKEN_LIFETIME_MINUTES','JWT_TTL','JWT_SECRET',
'GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI','FACEBOOK_CLIENT_ID','FACEBOOK_CLIENT_SECRET',
'FACEBOOK_REDIRECT_URI','AUTH_GUARD','AUTH_PASSWORD_BROKER','PAGINATION_PER_PAGE','CLOUDINARY_API_KEY',
'CLOUDINARY_API_SECRET','CLOUDINARY_CLOUD_NAME','CLOUDINARY_URL','FRONTEND_RESET_PASSWORD_URL','FRONTEND_EMAIL_VERIFICATION_URL',
'ACTIVATION_TOKEN_SECRET','ACTIVATION_TOKEN_TTL_HOURS',);
